...
> **Nombres seudonimizados.** Los nodos (`nodo-lab-01`, `nodo-02`…`nodo-04`) y los clústeres PostgreSQL preexistentes (`pg-alfa`, `pg-beta`, `pg-gamma`, `pg-delta`) llevan seudónimos consistentes en todo el paquete y en el artículo: el piloto se ejecutó sobre infraestructura productiva de un tercero. La topología y la co-residencia descritas son las reales. Quien reproduzca el experimento debe sustituirlos por los nombres de su propio entorno.
