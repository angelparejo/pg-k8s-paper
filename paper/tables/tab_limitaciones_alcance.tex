...
\addlinespace
Laboratorio en un solo nodo (\texttt{nodo-lab-01}) dentro de un clúster productivo compartido, con Chaos Mesh confinado al namespace. & Alta validez interna (aislamiento demostrado por compuerta GO/NO-GO); la validez externa multi-nodo no se aborda en este piloto. \\
\bottomrule
\end{tabular}
